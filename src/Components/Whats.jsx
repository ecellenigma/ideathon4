        ...
        <div class="checkbox">
            ...
            <div class="checkbox">
                <label class="checkbox-wrapper">
                    <span class="checkbox-tile">
                        <span class="checkbox-icon">
                            <svg  stroke="#fff" stroke-width="3" width="192px" height="192px" viewBox="-20 0 190 190" fill="none" 
            ...
            <div class="checkbox">
                <label class="checkbox-wrapper">
                    <span class="checkbox-tile">
                        <span class="checkbox-icon">
                            <svg fill="#fff" stroke-width="0.1" stroke="#fff" width="192px" height="192px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="checkbox">
                <label class="checkbox-wrapper">
                    <span class="checkbox-tile">
                        <span class="checkbox-icon">
                            <svg fill="#fff" width="192px" height="192px" viewBox="0 0 1000 1000" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" 
            ...
            <div class="checkbox">
                <label class="checkbox-wrapper">
                    <span class="checkbox-tile">
                        <span class="checkbox-icon">
                            <svg fill="#fff" stroke-version="0.5" version="1.1" id="XMLID_66_" width="192px" height="192px"
                                xmlns="http://www.w3.org/2000/svg" 
                                viewBox="0 0 24 24">
                                <g id="workshop">
                                    <g>
